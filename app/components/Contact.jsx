            ...
            <div className="pt-4">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-left">
                ...
                <div className="flex gap-4 pt-4">
                  <button
                    type="submit"
                    className="flex-1 px-8 py-4 rounded-full backdrop-blur-xl bg-purple-600/30 border border-purple-400/50 hover:bg-purple-600/50 hover:scale-95 transition-all duration-300 shadow-lg hover:shadow-purple-500/50 font-semibold"
                  >
                    Send Message
                  </button>
                  <button
